 ...
 * <p>
 * The {@link #provide(Type, TypeConstraint)} method returns {@code null} when
...
public interface ValueDeserializerProvider<T, R> {
	/**
	 * Provides a deserializer for a value of type {@code valueType} and a constraint
	 ...
	 */
	ValueDeserializer<T, R> provide(Type valueType, TypeConstraint resultType);
}
