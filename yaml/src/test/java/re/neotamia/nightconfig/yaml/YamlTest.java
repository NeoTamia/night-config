...
import static re.neotamia.nightconfig.core.file.FileNotFoundAction.THROW_ERROR;
...
public class YamlTest {
    ...
    public void testReadWrite() {
        ...
        config.set("objectList", List.of(config1, config2));
        config.set(List.of("not.a.subconfig"), "works");
        ...
        assertEquals("works", parsed.<String>get(List.of("not.a.subconfig")));
        ...
        expectedConfig.set("list", List.of(10, 12));
        expectedConfig.set("objectList", List.of(config1, config2));
        expectedConfig.set(List.of("not.a.subconfig"), "works");
