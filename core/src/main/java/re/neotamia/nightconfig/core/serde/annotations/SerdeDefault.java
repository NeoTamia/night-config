 ...
 * import static re.neotamia.nightconfig.core.serde.annotations.SerdeDefault.WhenValue.*;
 * import static re.neotamia.nightconfig.core.serde.annotations.SerdeDefault.SerdePhase.*;
 *
 * class MyObject {
